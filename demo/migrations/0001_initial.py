# Generated by Django 5.1.3 on 2025-08-26 03:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to='cars_photos/%Y/%m/%d/')),
            ],
            options={
                'verbose_name': 'Фото',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=100, null=True, verbose_name='Код присоединения к компании')),
                ('INN', models.CharField(blank=True, max_length=100, null=True, verbose_name='ИНН компании')),
                ('adress', models.CharField(blank=True, max_length=255, null=True, verbose_name='Юридический адрес')),
                ('website', models.CharField(blank=True, max_length=255, null=True, verbose_name='Сайт компании')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Контактное лицо')),
                ('company_name', models.CharField(max_length=100, verbose_name='Наименование компании(обязательно)')),
                ('phone', models.CharField(blank=True, max_length=100, null=True, verbose_name='Телефон компании')),
                ('address', models.CharField(blank=True, max_length=100, null=True, verbose_name='Адрес компании')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='ФИО пользователя')),
                ('role', models.CharField(default='client', max_length=20, verbose_name='Роль пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='demo.groups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drive_type', models.CharField(blank=True, max_length=100, null=True, verbose_name='Тип привода')),
                ('engine', models.CharField(blank=True, max_length=100, null=True, verbose_name='Двигатель')),
                ('power', models.CharField(blank=True, max_length=100, null=True, verbose_name='Мощность двигателя')),
                ('transmission', models.CharField(blank=True, max_length=100, null=True, verbose_name='Коробка передач')),
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('last_update', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('disable', 'Disable'), ('open', 'Open')], default='disable', max_length=20, verbose_name='Статус заявки')),
                ('deadline', models.DateTimeField(blank=True, null=True, verbose_name='Исполняющий менеджер')),
                ('url_users', models.CharField(blank=True, max_length=100, null=True, verbose_name='Исходная ссылка на авто')),
                ('url', models.CharField(blank=True, max_length=100, null=True, verbose_name='Конечная ссылка на авто')),
                ('opened_at', models.DateTimeField(blank=True, null=True)),
                ('arrived_time', models.DateTimeField(blank=True, null=True)),
                ('checklist_point1', models.CharField(blank=True, max_length=100, null=True)),
                ('checklist_point2', models.CharField(blank=True, max_length=100, null=True)),
                ('shown_to_bot', models.BooleanField(default=False, verbose_name='Уведомление боту показано')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
                ('photo', models.ManyToManyField(blank=True, null=True, to='demo.carsphoto', verbose_name='Фото')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='demo.companies', verbose_name='Компания')),
                ('dealer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='demo.dealers', verbose_name='Дилер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('owner', 'Владелец'), ('manager', 'Менеджер'), ('leading_manager', 'Ведущий менеджер'), ('logist', 'Логист')], default='manager', max_length=100)),
